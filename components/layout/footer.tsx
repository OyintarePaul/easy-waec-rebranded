...
export async function Footer() {
  ...
  return (
    <footer className="border-t border-gray-200 bg-gray-50 text-gray-600 dark:border-gray-800 dark:bg-card dark:text-gray-400">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider text-foreground dark:text-gray-200">
              Quick Links
            </h4>
            <ul className="mt-3 space-y-2 text-xs">
              ...
              <li>
                <Link href="/result" className="hover:text-primary">
                  Check Result
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="mt-3 text-xs">
              Email:{" "}
              <a href="mailto:support@easywaec.com" className="text-primary hover:underline">
