  ...
  return (
    <>
      ...
      <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <Card className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
      ...
      {!hasTransactions && (
        <Card className="mb-8 flex flex-col items-center justify-between gap-4 rounded-xl border border-emerald-200 bg-emerald-50/60 p-6 sm:flex-row dark:border-emerald-900/50 dark:bg-emerald-950/30">
          <div>
            <CardTitle className="text-base font-semibold text-emerald-900 dark:text-emerald-200">
              Ready to check your WAEC results?
            </CardTitle>
            <CardDescription className="mt-1 text-sm text-emerald-700 dark:text-emerald-400">
